...
# Randomization flags
parser.add_argument("--character", action="store_true", help="Randomize characters.", default=True)
parser.add_argument("--item", action="store_true", help="Randomize items and item.", default=True)
parser.add_argument("--spell", action="store_true", help="Randomize learnable spells.", default=True)
parser.add_argument("--monster", action="store_true", help="Randomize monsters.", default=True)
parser.add_argument("--movement", action="store_true", help="Randomize monster movements.", default=True)
parser.add_argument("--capsule", action="store_true", help="Randomize capsule monsters.", default=True)
parser.add_argument("--shop", action="store_true", help="Randomize shops.", default=True)
parser.add_argument("--treasure", action="store_true", help="Randomize treasure chests.", default=True)
parser.add_argument("--world", action="store_true", help="Create an open-world seed.", default=True)
