...
org $8EFD2E  ; unused region at the end of bank $8E
    ; TODO: start items at $01D2 (index 466) 
...
org $9EDC40  ; names
    DB "Selan       "       ; overwrites "Wind key    " ; TODO instead use "PURIFIA     "
    DB "Guy         "       ; overwrites "Cloud key   " ; TODO instead use "Tag ring    "
    DB "Arty        "       ; overwrites "Light key   " ; TODO instead use "Tag ring    "
    DB "Dekar       "       ; overwrites "Sword key   " ; TODO instead use "RAN-RAN step"
    DB "Tia         "       ; overwrites "Tree key    " ; TODO instead use "Tag candy   "
    DB "Lexis       "       ; overwrites "Flower key  " ; TODO instead use "Last        "
pullpc

; TODO: Don't use this section. (on overworld, capsule monsters are just available.)
...
; TODO: find out if this affects the Overworld
...
; TODO: Remove, not used for AncientCave
...
; TODO: Find out if this affects the Overworld
; Overworld probably doesn't need this shops code.
; shops
pushpc
org $83B442
    ; DB=$83, x=1, m=1
...
; TODO: remove this section, not used for Overworld
...
; TODO: Find out if this is needed for Overworld.
; mid-turn death fix
pushpc
org $85B544
...
; TODO: Remove, not used for Overworld.
