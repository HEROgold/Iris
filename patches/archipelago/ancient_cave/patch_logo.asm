...
; TODO: Iris Lufia 2 randomizer
; Lufia II: Rise of the Sinistrals (U) [!].sfc
; Remove all ancient cave related code.
; allow party member switching from inventory
...
; TODO: modify so this works for all getting all item's (from chests?)
TX:
...
; TODO: add a check for the maidens, engine, capsule monsters, submarine,
; defeated bosses, and other special events for Iris randomizer goals
...
org $9EDC40  ; names
    DB "Selan       "       ; overwrites "Wind key    " ; TODO: change to an unused overworld item
    DB "Guy         "       ; overwrites "Cloud key   " ; TODO: change to an unused overworld item
    DB "Arty        "       ; overwrites "Light key   " ; TODO: change to an unused overworld item
    DB "Dekar       "       ; overwrites "Sword key   " ; TODO: change to an unused overworld item
    DB "Tia         "       ; overwrites "Tree key    " ; TODO: change to an unused overworld item
    DB "Lexis       "       ; overwrites "Flower key  " ; TODO: change to an unused overworld item
pullpc
...
org $979F47  ; descriptions
    ...
    DB "FIRE                       "    : DB $00
org $9EDC88  ; names
    DB "JELZE       "       ; overwrites "Magma key   " ; TODO: change to an unused overworld item
    DB "FLASH       "       ; overwrites "Heart key   " ; TODO: change to an unused overworld item
    DB "GUSTO       "       ; overwrites "Ghost key   " ; TODO: change to an unused overworld item
    DB "ZEPPY       "       ; overwrites "Trial key   " ; TODO: change to an unused overworld item
    DB "DARBI       "       ; overwrites "Dankirk key " ; TODO: change to an unused overworld item
    DB "SULLY       "       ; overwrites "Basement key" ; TODO: change to an unused overworld item
    DB "BLAZE       "       ; overwrites "Narcysus key" ; TODO: change to an unused overworld item
pullpc
...
; TODO: do we need this for the Iris randomizer?
...
; TODO Not needed for the Iris randomizer
...
; TODO: Providence is not useful in overworld
