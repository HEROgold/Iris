...
; archipelago item
; NOTE: properties ($96F9AD) and name ($9EDD60) moved to Iris (basepatch.py::apply_ancient_cave_base)
org $9FA900  ; sprite
...
pushpc
; NOTE: party item properties ($96F875) moved to Iris (basepatch.py)
...
; NOTE: party item names ($9EDC40) moved to Iris (basepatch.py)
pullpc

; TODO: Don't use this section. (on overworld, capsule monsters are just available.)
; capsule monster items (IDs $01B8 - $01BE)
pushpc
; NOTE: capsule item properties ($96F8C3) moved to Iris (basepatch.py)
org $979F47  ; descriptions
    ...
    DB "SOIL                       "    : DB $00
    DB "FIRE                       "    : DB $00
; NOTE: capsule item names ($9EDC88) moved to Iris (basepatch.py)
pullpc
